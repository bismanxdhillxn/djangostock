...
# google_data = google_data.xs(stock, level='Ticker', axis=1)  # Extract only the relevant stock
x_test = pd.DataFrame(google_data['Close'][splitting_len:])
...
# scaled_data = scaler.fit_transform(x_test[('Close', stock)].values.reshape(-1, 1))
